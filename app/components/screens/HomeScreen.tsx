    ...
    <div className="fixed inset-0 w-full h-[100dvh] bg-black overflow-hidden">
      ...
      `}} />
        ...
        <div className="w-screen h-full flex-shrink-0 bg-black flex flex-col">
          {/* Header FIJO */}
          <div className="fixed top-0 left-0 right-0 z-10 px-4 pt-3 pb-3 flex items-center justify-between bg-black/95 backdrop-blur-sm border-b border-transparent">
            <button 
          ...
          {/* Contenido Central con padding-top para compensar header fijo */}
          <div className="flex-1 px-5 pt-16 pb-2 overflow-y-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <div className={`transition-opacity duration-300 ${isFocused ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          ...
          {/* Input FIJO en la parte inferior - Estilo AI */}
          <div className="fixed bottom-0 left-0 right-0 z-10 px-4 pb-6 pt-3 bg-gradient-to-t from-black via-black to-transparent">
            <div className="relative flex items-center gap-2 bg-[#1a1b26] rounded-full px-2 py-2 border border-[#2a2b45]">
              ...
              {chatInput.trim() ? (
                <button 
                  className="w-9 h-9 rounded-full bg-[#5b5fc7] flex items-center justify-center flex-shrink-0 active:bg-[#6b6fd7] transition-colors"
                >
