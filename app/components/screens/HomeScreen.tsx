...
export default function HomeScreen({ onNavigate, activeTab }: HomeScreenProps) {
  ...
  return (
    <MobileContainer className="bg-[#0e1028]">
      <div className="bg-[#0e1028] min-h-screen">
        <Header showLogo={true} onNavigate={onNavigate} />

        <div className="flex-1 overflow-y-auto pb-6 bg-[#0e1028]">
          <div className="space-y-0">
            ...
            {/* Navigation Tabs - Cada tab en su propio contenedor */}
            ...
            {/* Separador más ancho y centrado entre tabs y card de gasolina */}
            <div className="px-5 mb-6">
