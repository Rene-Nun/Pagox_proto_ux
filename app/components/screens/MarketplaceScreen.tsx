...
const Header = ({ title, onNavigate }) => (
  <header className="flex items-center justify-between p-4 bg-white border-b border-gray-200 shrink-0">
    ...
    <div className="w-8">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path d="M19 10c0 1.66-3.13 5-7 5s-7-3.34-7-5a7 7 0 1 1 14 0z"/></svg>
    </div>
  </header>
);
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 relative">
        ...
        {/* Indicador de página, también absoluto */}
