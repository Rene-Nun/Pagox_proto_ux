  ...
  return (
    <MobileContainer className="pb-20">
      ...
      <div className="p-4">
        ...
        {/* Logout Button */}
        <button className="w-full mt-6 p-4 bg-white rounded-2xl shadow-sm flex items-center justify-center gap-2 text-red-600 font-medium hover:bg-red-50 transition-colors">
